...
- Project skill `flask-blog-docs-after-task`: автозапуск в конце реализации (`00-project.mdc` + hook `stop`); таблица куда писать + CHANGELOG; связан с `docs-context` / AGENTS / backlog-sync.
