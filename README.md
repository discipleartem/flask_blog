...
## Структура проекта
    ...
    │   ├── main.py                 # Blueprint главной страницы
...
- Blueprint аутентификации (регистрация, вход, выход)
- Blueprint главной страницы (`main`)
- Шаблон главной страницы с приветствием пользователя
