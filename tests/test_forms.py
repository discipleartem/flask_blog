...
class MockForm(Form):
    ...
    )  # TODO: + Regexp(r'^\w+$', message='Invalid')
...
def test_form_validation_success(app):
    ...
    with app.test_request_context(method="POST"):
        ...
        form = MockForm(data)
        # TODO: После реализации валидаторов ожидать True только для корректных
        # данных
...
def test_form_validation_placeholder(app):
    ...
    with app.test_request_context(method="POST"):
        ...
        data = {
            ...
            # Корректный username (DataRequired)  # TODO: + Length min=3,
            # Regexp
            "username": "validuser",
            "csrf_token": token,
        }
...
def test_form_error_handling(app):
    ...
    with app.test_request_context():
        ...
        data = {
            ...
            # TODO: Regexp error (когда будет реализовано)
            "username": "user!@#",
            "csrf_token": token,
        }
        form = MockForm(data)
...
def test_validators_standalone():
    ...
    # assert r("invalid!@#") == (True, None)  # TODO: должно быть (False,
    # message)
