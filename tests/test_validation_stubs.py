...
class TestForm(Form):
    ...
    name = StringField(
        ...
        validators=[
            ...
            # TODO: Regexp(r'^[a-zA-Z]+$', message='Only letters') - будет
            # реализован в будущем
        ],
    )
    confirm = StringField("Confirm", validators=[EqualTo("name", message="Must match")])
...
def test_form_field_still_populates_data(app):
    ...
    with app.test_request_context():
        data = {"name": "test_name", "confirm": "test_name"}
